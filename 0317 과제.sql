...
CREATE TABLE PRODUCTS(
	...
	CATEGORY NUMBER CONSTRAINT PRODUCTS REFERENCES CATEGORIES(CATEGORY_ID),
...
CREATE TABLE ORDERS(
	...
	CUSTOMER_ID NUMBER CONSTRAINT ORDERS REFERENCES CUSTOMERS(CUSTOMER_ID)
	ON DELETE CASCADE
);
...
CREATE TABLE ORDER_DETAILS(
	...
	ORDER_ID NUMBER CONSTRAINT ORDER_DETAILS REFERENCES ORDERS(ORDER_ID)
	ON DELETE CASCADE,
